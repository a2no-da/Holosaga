...
캐릭터별 버프 적용 로직은 switch (buffName) 형태로 캐릭터 이름별 분기가 하드코딩되어 있어, 캐릭터가 20개 이상으로 늘어나며 반복적인 케이스 추가가 계속 필요했습니다. 아티팩트 시스템에 적용한 구조를 버프 시스템에도 동일하게 적용했다면 확장성 문제를 줄일 수 있었을 것 같습니다.
